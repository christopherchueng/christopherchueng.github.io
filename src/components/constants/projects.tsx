...
const two: Project = {
    ...
    technologies: ["Javascript", "React", "Redux", "Python"],
    description: "A Robinhood clone that allow users to experience a mock-up of the American financial market through trading a variety of stocks under the S&P 500 Index.",
}
